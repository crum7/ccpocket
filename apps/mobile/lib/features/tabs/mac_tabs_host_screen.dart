...
/// pass-through that just renders [SessionListScreen].
///
/// Tab 0 is always the home (session list). Tabs 1..N are open sessions
/// kept alive via [IndexedStack] so their state survives tab switches.
@RoutePage()
