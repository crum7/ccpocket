...
// based on provider (Claude=off, Codex=on).
 ...
 List<SlashCommand> get slashCommands;/// WebSocket URL when the session runs in shared app-server mode.
...
as List<SlashCommand>,remoteUrl: freezed == remoteUrl ? _self.remoteUrl : remoteUrl // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of ChatSessionState
